...
const isRazorpayConfigured = process.env.RAZORPAY_KEY && process.env.RAZORPAY_SECRET && process.env.RAZORPAY_KEY !== "rzp_test_placeholder";
...
app.get("/api/payment/key", (req, res) => {
  res.json({ key: process.env.RAZORPAY_KEY || "rzp_test_placeholder" });
});
